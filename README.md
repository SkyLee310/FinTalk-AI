...
`GEMINI_MODEL_EMBEDDING` is optional. When configured, it enables semantic meeting retrieval and Ask FinTalk AI. Without it, the core meeting-processing pipeline can still run, but semantic retrieval and Ask FinTalk AI are unavailable.

Model IDs come from [AI Studio](https://aistudio.google.com/apikey) rather than hardcoded.
